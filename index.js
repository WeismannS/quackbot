...
Commands.push(
  ...
  new Command('Gets the pfp of a user', 'getpfp', (message,args)=> {
    ...
    return  user ? message.channel.send(user.displayAvatarURL({size:1024,forceStatic:true})) : message.channel.send(`no user, wat?`)
    }
